package com.hardhand.wedder.cli;
...
public class RenderCommand extends ConfiguredCommand<WedderConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<WedderConfiguration> bootstrap,
                       Namespace namespace,
                       WedderConfiguration configuration) throws Exception {
